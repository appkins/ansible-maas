...
sudo apt install postgresql-14 postgresql-server-dev-14 -y

sudo maas init region+rack

sudo maas createadmin --username=$PROFILE --email=$EMAIL_ADDRESS

sudo maas init rack --admin-username appkins --admin-password monica --admin-email nbatkins@gmail.com --admin-ssh-import gh:appkins

sudo maas createadmin --username=appkins --email=nbatkins@gmail.com --password=monica
